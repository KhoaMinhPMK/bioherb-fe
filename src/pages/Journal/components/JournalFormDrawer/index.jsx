 ...
 *
 * Domain component — belongs to Journal feature, NOT shared.
 */
const JournalFormDrawer = ({ isOpen, onClose, onSubmit, title, children, submitting = false }) => {
        ...
        <>
            ...
            <aside className="journal-drawer" role="dialog" aria-label={title}>
                <div className="journal-drawer__header">
                    ...
                    <button className="journal-drawer__close" onClick={onClose} aria-label="Đóng">
                        <X size={20} />
                    </button>
                </div>
                <form className="journal-drawer__body" onSubmit={handleSubmit}>
                    <div className="journal-drawer__content">{children}</div>
